        ...
        created(){
            ...
            if ( $.allowMachine == 1) 
            {
               //设置标题；开花好地方、兰精灵、掌上松阳
                ...
                //全局访问地址
                $.ajaxGlobalUrl = 'http://p.cztv.com' //http://10.30.10.158

                //allowMachine等于1时，天气配置
                $.clinet_host_weather = 'https://restapi.amap.com'
                //开化id:330824 ，兰溪:330781 ，松阳:331124，洞头:330305
                $.clinet_CityKey = "330305" ; self.special_navShow = ($.clinet_CityKey != "330781" && $.clinet_CityKey != "331124") 
                //key固定
                $.clinet_GDWeatherKey = "22f5a259075e17d861ee8b04193e1d66" 

                //调整各县融appid和appversion
                $.clinet_appid = '9a9429b23340d70db2d89ea6ca271668'
                $.clinet_appversion = '1.0.5'
                $.clinet_clientid = ''
		...
		methods:{
            ...
            */
            click_content_particular_back(){
                let self = this
                self.nav_show = false
                self.newslist_show = self.status_show = self.tab_show = true
