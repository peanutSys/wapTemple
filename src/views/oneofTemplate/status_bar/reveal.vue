<template>
    <div :style='style__'>
        <ImageLayout :class='"reveal "+randomMark' :layout_data='geted_data'></ImageLayout>
    </div>
</template>
	...
	export default {
		...
		methods:{
            setLayout(){
                ...
                self.$nextTick( ()=>{
                    {   
                        $('.reveal'+self.getRandomClassName() ).css({
                            backgroundImage:'url('+require('static/img/edit_pen.png')+')',
                        })
